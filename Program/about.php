...
<html lang="en" id="home">
  ...
  <body>
    ...
    <div class="jumbotron text-center">
        ...
        <hr>
          <p>Website ini merupakan website E-commerce yang memiliki fitur untuk merekomendasikan game berdasarkan dari kemiripan genrenya.</p>
          <p>Website ini berfokus kepada sistem rekomendasi. Sehingga, e-commerce disini hanya sebagai tempat pengimplementasian dari sistem rekomendasinya saja.</p>
    </div>
    <!-- Akhir jumbotron -->
    ...
    <!-- <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-sm-offset-3 text-justify">
            <p>Website ini merupakan website E-commerce yang memiliki fitur untuk merekomendasikan game berdasarkan dari kemiripan genrenya.</p>
            <p>Website ini berfokus kepada sistem rekomendasi. Sehingga, e-commerce disini yang sebagai tempat pengimplementasian dari sistem rekomendasinya.</p>
          </div>
        </div>
      </div>
    </section> -->
