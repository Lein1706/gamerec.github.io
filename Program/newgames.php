...
$games = query("SELECT * FROM game WHERE tahun >= 2020")
?>
  ...
  <body>
    ...
    <section class="content" id="content">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h2 class="text-center"><strong>New Games</strong></h2>
            <hr>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-4">
                <a href='' class="thumbnail">
                  <img src="img/FA11.jpg">
                </a>
            </div>
            <div class="col-sm-4">
                <a href='' class="thumbnail">
                  <img src="img/FA12.jpg">
                </a>
            </div>
            <div class="col-sm-4">
                <a href='' class="thumbnail">
                  <img src="img/FA13.jpg">
                </a>
            </div>
            <div class="col-sm-4">
                <a href='' class="thumbnail">
                  <img src="img/FA14.jpg">
                </a>
            </div>
            <div class="col-sm-4">
                <a href='' class="thumbnail">
                  <img src="img/FA15.jpg">
                </a>
            </div>
            <div class="col-sm-4">
                <a href='' class="thumbnail">
                  <img src="img/FA16.jpg">
                </a>
            </div>
        </div>
        </div>
