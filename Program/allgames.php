...
$games = query("SELECT * FROM game ORDER BY namagame LIMIT $awalData, $jumlahDataPerHalaman ");
...
<html lang="en" id="home">
  ...
  <body>
    ...
    <section class="content" id="content">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h2 class="text-center"><strong>All Games</strong></h2>
            <hr>
          </div>
        </div>
        <div class="row">
  ...
  <ul class="pager">
    <?php if($halamanAktif > 1): ?>
        <li class="previous, col-sm-4">
          <a href="?page=<?= $halamanAktif - 1 ?>">&larr; Previous</a></li>
    <?php endif; ?>

    <?php if($halamanAktif < $jumlahHalaman): ?>
        <li class="next, col-sm-4 col-sm-offset-4">
          <a href="?page=<?= $halamanAktif + 1 ?>">Next &rarr;</a></li>
    <?php endif; ?>
  </ul>
    </section>
